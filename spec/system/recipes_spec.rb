...
RSpec.describe 'Recipes', type: :system do
  describe '材料費の計算' do
    it '複雑でない材料名の計算' do
      ...
      expect(page).to have_content('628kcal')
      expect(page).to have_content('炭水化物')
      expect(page).to have_content('67g')
      expect(page).to have_content('タンパク質')
      expect(page).to have_content('52g')
      expect(page).to have_content('脂質')
      expect(page).to have_content('16g')
      expect(page).to have_content('食物繊維')
      expect(page).to have_content('3.7g')
      expect(page).to have_content('塩分相当量')
      expect(page).to have_content('3.5g')
    end
    it '分量で分数あり' do
      visit root_path
      ...
      expect(page).to have_content('2.6')
      expect(page).to have_content('豆板醤')
      expect(page).to have_content('8.2')
      expect(page).to have_content('カロリー')
      expect(page).to have_content('248kcal')
      expect(page).to have_content('炭水化物')
      expect(page).to have_content('15g')
      expect(page).to have_content('タンパク質')
      expect(page).to have_content('14g')
      expect(page).to have_content('脂質')
      expect(page).to have_content('14g')
      expect(page).to have_content('食物繊維')
      expect(page).to have_content('3.2g')
      expect(page).to have_content('塩分相当量')
      expect(page).to have_content('1.8g')
    end
    it '分量で()あり' do
      visit root_path
      ...
      expect(page).to have_content('カロリー')
      expect(page).to have_content('229kcal')
      expect(page).to have_content('炭水化物')
      expect(page).to have_content('13g')
      expect(page).to have_content('タンパク質')
      expect(page).to have_content('32g')
      expect(page).to have_content('脂質')
      expect(page).to have_content('6g')
      expect(page).to have_content('食物繊維')
      expect(page).to have_content('3.1g')
      expect(page).to have_content('塩分相当量')
      expect(page).to have_content('1.9g')
    end
  end
end
